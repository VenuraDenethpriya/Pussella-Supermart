...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, weight, mweight, category, details, price, image) VALUES(?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $weight, $mweight, $category, $details, $price, $image]);
...
<section class="show-products">
   ...
   ?>
   <div class="box">
      <div class="price"><span><?= $fetch_products['weight']; ?></span><span><?= $fetch_products['mweight']; ?></span> <br>Rs <?= $fetch_products['price']; ?>/-</div>
